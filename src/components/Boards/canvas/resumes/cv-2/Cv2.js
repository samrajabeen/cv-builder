...
class Cv2 extends Component {
      ...
      skillsObject[index] = {
        item: (
          <Group y={heightToAdd} x={40 + numberInLine * 100}>
            <Text
              text={this.props.values.skills[index].name}
              fontFamily='Poppins'
              fontSize={12}
              fontStyle='bold'
            />
            ...
            <Group x={60}>
              <Circle
                ...
                width={5}
                fill={
                  this.props.values.skills[index].rating > 0
                    ? '#F0C30E'
                    : '#D3D3D3'
                }
              ></Circle>
              <Circle
                ...
                width={5}
                fill={
                  this.props.values.skills[index].rating > 30
                    ? '#F0C30E'
                    : '#D3D3D3'
                }
              ></Circle>
              <Circle
                ...
                width={5}
                fill={
                  this.props.values.skills[index].rating > 50
                    ? '#F0C30E'
                    : '#D3D3D3'
                }
              ></Circle>
              <Circle
                ...
                width={5}
                fill={
                  this.props.values.skills[index].rating > 80
                    ? '#F0C30E'
                    : '#D3D3D3'
                }
              ></Circle>
              <Circle
                ...
                width={5}
                fill={
                  this.props.values.skills[index].rating > 90
                    ? '#F0C30E'
                    : '#D3D3D3'
                }
              ></Circle>
  ...
  checkForDownload() {
    ...
    if (this.props.pages > 1) {
      var dataUrl = this.stageRef
        .getStage()
        .toDataURL({ pixelRatio: 4, y: 637 });
      var doc = new jsPDF('p', 'mm', 'a4');
      var width = doc.internal.pageSize.getWidth();
      var height = doc.internal.pageSize.getHeight();
      const pdf = new jsPDF();
  ...
  componentDidUpdate() {
    if (this.layer != undefined) {
      if (
        parseInt(this.layer.getClientRect().height) > 620 &&
        this.props.pages == 1
      ) {
        this.props.addPage();
      }
    ...
    return (
      ...
      >
        <Layer
          ...
          y={this.props.currentPage > 1 ? -650 : 0}
        >
          {/* Circle */}
          ...
          <Group
            ref={node => {
              this.employmentsRef = node;
            }}
            y={
              this.summaryRef
                ? 185 + this.summaryRef.getClientRect().height
                : 220
            }
          >
          ...
          <Group
            ref={node => {
              this.educationsRef = node;
            }}
            y={
              this.summaryRef && this.employmentsRef
                ? 200 +
                  (this.summaryRef.getClientRect().height +
                    this.employmentsRef.getClientRect().height)
                : 220 + 40
            }
          >
            <Rect width={310} height={2} x={140} fill='black' />
          ...
          <Group
            ...
            y={
              this.summaryRef && this.employmentsRef
                ? 205 +
                  (this.summaryRef.getClientRect().height +
                    this.educationsRef.getClientRect().height +
                    this.employmentsRef.getClientRect().height)
                : 250 + 40
            }
          >

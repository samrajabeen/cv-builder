    ...
    if (this.state.passwordRepeat == this.state.password) {
      fire
        ...
        .then(u => {
          ...
          addUser(u.user.uid, 'Welcome', 'Back');
        })
        .then(u => {
          //    console.log(u)
      ...
      <div className='auth'>
        ...
        <div className='body'>
          <form onSubmit={this.signUp} className='registerForm'>
            ...
            />
            <p className='policy'>
              By clicking the "Register" button, you are creating an account
              with Creme Talent, and you agree to our Terms of Use and Privacy
              Policy.
            </p>
        ...
        <div className='modalFooter'>
          <span>
            ...
            <a onClick={() => this.props.handleNavigationClick()}>Login</a>
          </span>
        </div>
      </div>
    );
